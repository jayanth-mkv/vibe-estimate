...
const roots = ['production', 'delivery', 'runtime', 'events', 'firebase-billing', 'firebase-migration', 'firebase-migration-verification', 'firebase-source-freeze', 'firebase-source-retirement', 'firebase-adoption', 'gemini-local', 'guardrails'];
