...
1. Open the home workspace and choose **Try the lighting example**. Sign-in happens as the example is saved; the original agreement and conversation stay together. The illustrated product tour is still available at `/welcome`.
...
To use your own sources, choose **Start a project**. First name it and paste the agreed scope; continue to client messages. Back preserves your text. Sign-in and persistence happen on **Save project**. The project then guides you through Review and Draft, while returning visits show each saved project's next step.
